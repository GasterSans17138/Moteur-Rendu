...
#include "Model.hpp"
#include "CharacterMouvement.hpp"
#include "App.hpp"
#include <imgui.h>
...
void LoadDefaultScene(Scene* scene)
{
	...
	// Initialize a cube.
	GameObject& cube = scene->Instantiate("Cube");
	cube.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
	...
	wall.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram()));
	...
	wall1.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	wall2.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	playerGraphics.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Goomba"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("goomba mat")));
	...
	ground.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	ground1.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	ground2.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	ground3.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	ground4.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Cube"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram(), (Material*)ResourceManager::Get("Ground Mat")));
	...
	sphere.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Sphere"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram()));
	...
	sphere1.AddComponent(new LowRenderer::Mesh((Model*)ResourceManager::Get("Sphere"),
		((ShaderProgram*)ResourceManager::Get("ShaderProgram"))->GetProgram()));
