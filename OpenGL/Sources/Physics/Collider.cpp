...
namespace Physics
{
	Collider::Collider(ColliderType type) :
		mModel(nullptr), Type(type)
	{
		Resources::Shader* shader = Resources::ResourceManager::GetInstance()->Create<Resources::Shader>("shaderCollider", "");
		ASSERT(shader->SetVertexShader("Resources/Shaders/collider.vert"), "Could not load the vertex shader");
		ASSERT(shader->SetFragmentShader("Resources/Shaders/collider.frag"), "Could not load the fragment shader");
	...
	BoxCollider::BoxCollider() : Collider(ColliderType::COLT_BOX)
	{
	...
	SphereCollider::SphereCollider() : Collider(ColliderType::COLT_SPHERE)
	{
	...
	CapsuleCollider::CapsuleCollider() : Collider(ColliderType::COLT_CAPSULE)
	{
