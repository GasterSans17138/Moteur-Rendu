...
namespace Core
{
	namespace DataStructure
	{
		...
		public :
			...
			GameObject& Instantiate(std::string _name, Core::myMath::Vec3 _position = Core::myMath::Vec3(),
				Core::myMath::Vec3 _rotation = Core::myMath::Vec3(), Core::myMath::Vec3 _scale = Core::myMath::Vec3(1, 1, 1));
